...
const xMargin = (width - numSquares * squareWidth) / 2;
const yMargin = (height - numSquares * squareWidth) / 2 + 50;
...
// // Get Item
// gazePositionInfoJSON = window.localStorage.getItem('gazePositionInfo');
